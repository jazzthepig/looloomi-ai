...
const CSS = `
  ...
  .lm-tab { padding:5px 14px;border-radius:5px;font-size:12px;font-weight:500;font-family:'Syne',sans-serif;cursor:pointer;outline:none;border:1px solid rgba(0,0,0,0.08);background:transparent;color:#6B7280;transition:all .18s ease;letter-spacing:.01em; }
  ...
  .filter-btn { padding:4px 10px;border-radius:4px;font-size:11px;font-weight:500;font-family:'Syne',sans-serif;cursor:pointer;outline:none;border:1px solid rgba(0,0,0,0.08);background:transparent;color:#9CA3AF;transition:all .15s ease; }
            ...
            <div style={{ paddingTop: 6, borderTop: `1px solid ${T.border}` }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 4 }}>
                {Object.entries(selectedProtocol.scores).filter(([k]) => k !== "total").map(([key, val]) => (
                  <div key={key} style={{ textAlign: "center", padding: 4, background: "rgba(13,32,56,0.5)", borderRadius: 3 }}>
