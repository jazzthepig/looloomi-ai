...
**Last updated:** 2026-07-19→2026-07-20 (Minimax-B; §CIS-HISTORY-BACKFILL re-run complete + R45 refined by cadence × sub-period deepening: **R45 🔴 originally logged as "composite CIS L/S REFUTED at daily construction"** — but R46 ✅ REFINEMENT (2026-07-20, per Jazz's "不要立刻改，再继续深化研究") shows **daily-rebal was overfit, 5-day rebal SURVIVES the 3-check gauntlet**: pillar_O 5d/5bps = **t=+3.33, ann=+70.1%, turnover 80**; composite CIS 5d/5bps = t=+2.64, ann=+50.3%, turnover 66; pillar_O alone beats composite at every cadence. Sub-period OOS shows the W5 (2025-10→2026-02) sign-flip is **regime-specific late-cycle risk-on, not structural** — 5/6 windows positive for O. **R45 diagnosis flips: not "edge scale insufficient" but "daily-rebal extracts a DIFFERENT signal than the cleaner mid-frequency edge."** Composite CIS is now promotable to a real book factor at 5-day construction + regime-conditioning. pillar_S dead at every cadence (5bps t in {−0.77..+0.56}), confirms "demote S" finding. **PENDING decision (per Jazz's hold):** R47 candidate = regime-conditioned pillar_O L/S sleeve (5d rebal + skip risk-on-late-cycle); CIS v5 weight reweight suggestion (toward O, away from S) for Minimax-A. Production paper holding-pattern preserved. Aggregate lesson #13 sharpened: gauntlet must SWEEP CONSTRUCTION CHOICES, not just test one point — otherwise we close ideas that work at a different setting. Run artifacts at `reports/cis_quality_robustness/2026-07-20/{verdict.json,REPORT.md}` (gitignored local). Previous state preserved below for context.)
