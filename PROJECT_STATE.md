...
**Last updated:** 2026-07-27 (Seth — **🔴 §STRATEGY-2 — R96 cross-asset bond-equity β-residual L/S REFUTED; 14-attempt graveyard COMPLETE.** R96 moved to a structurally different data class: 33 TradFi assets from the EODHD local SQLite buffer, 249 daily observations (2025-07-29 → 2026-07-24), score = 60d rolling β_TLT − β_SPY lagged 1d, market-neutral tercile L/S, 6 cadences × 5 cost tiers = 30 cells. Best 5d/0bps cell: full_t=−0.347, OOS_t=+0.845, maxDD=−14.25%, Sharpe=+0.477; 5bps_t=+0.188 and 10bps_t=+0.104, zero realistic-cost passing cells. Absorption fails (alpha_t=−0.63); SPY β=+0.919/t=+8.54 dominates — beta-tilted book in disguise. W2/W4/W6 negative and W3/W5 positive with extreme amplitude. **Lesson #63:** panel-length constraint survives even the data-class pivot; 249 TradFi days cannot validate a second tradeable sleeve. Strategy 1 remains R77 LOCKED; Strategy 2 remains STRUCTURALLY DEFERRED pending §OHLCV-EXTENSION. Frozen R77 weights unchanged. 14/14 smoke tests + preflight PASS; no production change; Mac-side commit required.**)
