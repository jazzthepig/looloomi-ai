...
_VAULT_FUNDS = [
    ...
    },
    {
        ...
        "grade": None,
        "description": "Hong Kong-based structured yield specialist operating on-chain vaults via Drift Protocol. Partner fund delivering institutional-grade returns through systematic DeFi strategies.",
        "team": None,
