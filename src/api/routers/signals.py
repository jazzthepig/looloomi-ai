    ...
    for asset in assets:
        ...
        # ── Open new signal if not already open ─────────────────────────────
            ...
            row = {
                ...
                "pillar_f":     _safe(asset.get("pillar_f") or (asset.get("pillars") or {}).get("F")),
                "pillar_m":     _safe(asset.get("pillar_m") or (asset.get("pillars") or {}).get("M")),
                "pillar_o":     _safe(asset.get("pillar_o") or (asset.get("pillars") or {}).get("O")),
                "pillar_s":     _safe(asset.get("pillar_s") or (asset.get("pillars") or {}).get("S")),
                "pillar_a":     _safe(asset.get("pillar_a") or (asset.get("pillars") or {}).get("A")),
